            ...
            <form method ="POST">   
                ...
                <div class="text-center">
                    ...
                    <div class="form_group">
                        ...
                        <input type="text" name="NB_QUESTIONS" size ="50" value="10"/> <br/>
                    </div>
                    <div class="form-group">
                        <label for="TIMER_MIN">Rentrez le temps d'une partie: </label>
                        <input type="text" name="TIMER_MIN" size ="50"/> minutes et 
                        <input type="text" name="TIMER_SEC" size ="50"/> secondes<br/>
                    </div>
                    <div class="form_group">
                        <label for="DESC_THEME">Rentrez une description du thème: </label>
                        <input type="textarea" name="DESC_THEME" size ="50"/> <br/>
                    </div>
                    <div class="form-group">
                    ...
                    </br><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#AjoutTheme"> Ajouter</button>
